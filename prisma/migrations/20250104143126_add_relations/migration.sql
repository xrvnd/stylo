...
INSERT INTO "new_Order" ("createdAt", "customerId", "dueDate", "employeeId", "id", "notes", "orderDate", "status", "totalAmount", "updatedAt") SELECT "createdAt", "customerId", "dueDate", "employeeId", "id", "notes", "orderDate", "status", "totalAmount", "updatedAt" FROM "Order";
DROP TABLE "Order";
...
CREATE TABLE "new_OrderImage" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "OrderImage_orderId_fkey" FOREIGN KEY ("orderId") REFERENCES "Order" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
